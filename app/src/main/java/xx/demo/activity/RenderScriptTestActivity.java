...
public class RenderScriptTestActivity extends BaseActivity
{
    ...
    public void createChildren(FrameLayout parent, FrameLayout.LayoutParams params)
    {
        ...
        params.bottomMargin = PxUtil.sV_1080p(200);
        ...
        if (config instanceof CirclePointConfig)
        {
            ...
            ((CirclePointConfig) config).mPointW = PxUtil.sU_1080p(22);
            ((CirclePointConfig) config).mMovablePointWH = PxUtil.sU_1080p(54);
            ...
            ((CirclePointConfig) config).mDistanceBetweenPointAndPoint = PxUtil.sU_1080p(72);
            ((CirclePointConfig) config).mLeftMargin = PxUtil.sU_1080p(59);
            ((CirclePointConfig) config).mRightMargin = PxUtil.sU_1080p(59);
            ...
            ((CirclePointConfig) config).mDistanceBetweenPointAndValue = PxUtil.sV_1080p(10);
